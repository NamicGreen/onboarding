import React, { useState, cloneElement, forwardRef as forwardRef$1, useLayoutEffect, useEffect, useRef, useCallback, useMemo } from 'react';
...
var TipContent = function (_a) {
    var start = _a.start, step = _a.step, lastStep = _a.lastStep, curretStepConfig = _a.curretStepConfig, previousStep = _a.previousStep, nextStep = _a.nextStep, onClose = _a.onClose;
    return (React.createElement("div", null,
        React.createElement("div", { className: 'tipWrapper' }, curretStepConfig === null || curretStepConfig === void 0 ? void 0 : curretStepConfig.content),
        React.createElement("div", { className: 'tipDotsWrapper' },
            React.createElement("div", { className: 'tipDots' }, Array(lastStep)
                .fill(0)
                .map(function (_, key) { return (React.createElement("span", { className: step === key + 1 ? 'active' : 'dot', key: key })); }))),
        start && (React.createElement("div", { className: 'tipFooter' },
            React.createElement("button", { disabled: step === 1, onClick: previousStep }, "Back"),
            step !== lastStep && React.createElement("button", { onClick: onClose }, "Skip"),
            React.createElement("button", { onClick: step !== lastStep ? nextStep : onClose }, step !== lastStep ? 'Next' : 'Close')))));
};
var OnBoarding = function (_a) {
    var id = _a.id, config = _a.config, _b = _a.start, start = _b === void 0 ? false : _b, onClose = _a.onClose;
    ...
    var onRectClick = useCallback(function (e) {
        e.preventDefault();
        nextStep();
    }, []);
    useEffect(function () {
    ...
    var curretStepConfig = useMemo(function () {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Tippy, { placement: "auto", reference: (curretStepConfig === null || curretStepConfig === void 0 ? void 0 : curretStepConfig.element) || null, allowHTML: true, content: React.cloneElement(React.createElement(TipContentElement, null), {
                start: start,
                step: step,
                lastStep: lastStep,
                ...
                nextStep: nextStep,
                onClose: onClose
            }), animation: 'shift-toward-subtle', visible: visible }),
        React.createElement("div", { id: id, ref: rectRef, style: { visibility: 'hidden' }, className: "hightlightRect " + (config.showBackdrop ? 'withDropshadow' : ''), onClick: onRectClick })));
};
